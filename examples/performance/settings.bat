...
REM A date-time window of the loaded parameters history. Last full day i.e. yesterday by default,
...
REM An output files directory. It is specified as a last full day i.e. yesterday like .../2018-07-04
